    ...
    class Mps000010Processor : AbstractProcessor
    {
        ...
        private void SetSingleKey()
        {
            try
            {
                ...
                {
                    if (rdo.PatyAlterBhyt.RIGHT_ROUTE_TYPE_CODE == "CC")
                    {
                    ...
                    {
                        SetSingleKey(new KeyValue(Mps000010ExtendSingleKey.TRAI_TUYEN, "X"));
                    }
                    ...
                    if (rdo.currentTreatment.OUT_TIME.HasValue && rdo.PatyAlterBhyt.HEIN_CARD_TO_TIME.HasValue)
                    {
                        ...
                        {
                            SetSingleKey(new KeyValue(Mps000010ExtendSingleKey.EXPIRED_HEIN_CARD, "X"));
                            SetSingleKey(new KeyValue(Mps000010ExtendSingleKey.UNDETERMINED_HEIN_CARD, ""));
                        }
                        else
                        {
                            SetSingleKey(new KeyValue(Mps000010ExtendSingleKey.EXPIRED_HEIN_CARD, ""));
                            SetSingleKey(new KeyValue(Mps000010ExtendSingleKey.UNDETERMINED_HEIN_CARD, ""));
                        }
                    }
                    else
                    {
                        SetSingleKey(new KeyValue(Mps000010ExtendSingleKey.EXPIRED_HEIN_CARD, ""));
                        SetSingleKey(new KeyValue(Mps000010ExtendSingleKey.UNDETERMINED_HEIN_CARD, "X"));
                    }
                }
                else
                {
