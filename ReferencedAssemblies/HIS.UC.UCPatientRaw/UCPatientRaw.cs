    ...
    public partial class UCPatientRaw : UserControl
    {
        ...
        private void cboPatientType_Closed(object sender, ClosedEventArgs e)
        {
            try
            {
                ...
                else if (lciCCCD_NUMBER.Visibility == DevExpress.XtraLayout.Utils.LayoutVisibility.Always)
                {
                    txtCCCD_Number.Focus();
                    txtCCCD_Number.SelectAll();
                }
            ...
            try
            {
                ...
                else if (gridViewPopUp.GetFocusedRow().GetType() == typeof(HIS_POSITION))
                {
                    ...
                    if (item != null)
                    {
                        ...
                        if (lciCCCD_NUMBER.Visibility == DevExpress.XtraLayout.Utils.LayoutVisibility.Always)
                        {
                            txtCCCD_Number.Focus();
                            txtCCCD_Number.SelectAll();
                        }
        ...
        private void txtCCCD_Number_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
