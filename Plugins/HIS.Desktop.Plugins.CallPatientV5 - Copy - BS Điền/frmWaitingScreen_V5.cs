...
(gridpatientBodyForceColorCodes[0], gridpatientBodyForceColorCodes[1], gridpatientBodyForceColorCodes[2]);
        ...
        private void SetDataToCurrentPatientCall(ServiceReq1ADO serviceReq1ADO)
        {
            try
            {
                ...
                {
                    lblPatientName.Text = serviceReq1ADO.TDL_PATIENT_NAME + serviceReq1ADO.TDL_PATIENT_DOB.ToString().Substring(0, 4);
        ...
        private void SetDataToLabelMoiBenhNhanChild()
        {
            ...
            try
            {
                ...
                if (time1Tick < 10000)
                {
                    if (time1Tick % 2 == 0)
                    {
                        lblPatientName.ForeColor = Color.Blue;
                        lblSoThuTuBenhNhan.ForeColor = Color.Blue;
                    }
                    else
                    {
                        lblPatientName.ForeColor = Color.Green;
                        lblSoThuTuBenhNhan.ForeColor = Color.Green;
                    }
                }
                if (time1Tick > 20000)
                {
