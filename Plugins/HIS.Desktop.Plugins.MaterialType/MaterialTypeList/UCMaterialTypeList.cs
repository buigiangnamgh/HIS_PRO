    ...
    public partial class UCMaterialTypeList : UserControl
    {
        ...
        private void InitMaterialTypeTree()
        {
            try
            {
                ...
                MaterialTypeColumn heinLimitPriceCol = new MaterialTypeColumn(Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY__UC_MATERIAL_TYPE__TREE_MATERIAL_TYPE__COLUMN_HEIN_LIMIT_PRICE", ResourceLangManager.LanguageUCMaterialType, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture()), "HEIN_LIMIT_PRICE", 120, false);
                heinLimitPriceCol.VisibleIndex = 12;
                heinLimitPriceCol.Format = new DevExpress.Utils.FormatInfo();
                heinLimitPriceCol.Format.FormatType = DevExpress.Utils.FormatType.Custom;
                heinLimitPriceCol.UnboundColumnType = DevExpress.XtraTreeList.Data.UnboundColumnType.Bound;
                ado.MaterialTypeColumns.Add(heinLimitPriceCol);
        ...
        private void LoadData(int? isReusable = null)
        {
            try
            {
                ...
                List<String> ColnParams = new List<string> { "ID", "MATERIAL_TYPE_CODE", "MATERIAL_TYPE_NAME", "SERVICE_UNIT_NAME", "CONCENTRA",
                    ...
                    "IMP_VAT_RATIO","IMP_PRICE","PACKING_TYPE_NAME","IS_BUSINESS", "IS_DRUG_STORE", "LOCKING_REASON", "IS_REUSABLE", "HEIN_LIMIT_PRICE"};
