    ...
    public partial class UCTestServiceReqExcute : HIS.Desktop.Utility.UserControlBase
    {
        ...
        private void LoadDataMachine()
        {
            try
            {
                ...
                if (this.currentServiceReq != null && this._Machines != null && this._Machines.Count > 0)
                {
                    long execId = this.currentServiceReq.EXECUTE_ROOM_ID;

                    this._Machines = this._Machines
                                     .Where(o =>
                                     {
