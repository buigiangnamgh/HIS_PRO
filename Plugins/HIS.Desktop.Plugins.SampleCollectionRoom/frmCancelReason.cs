...
namespace HIS.Desktop.Plugins.SampleCollectionRoom
{
    public partial class frmCancelReason : HIS.Desktop.Utility.FormBase
    {
        ...
        TreatmentSampleListViewADO treatmentSample;
        ...
        public frmCancelReason(Inventec.Desktop.Common.Modules.Module module, TreatmentSampleListViewADO _lisSample, string _roomCode, DelegateRefreshData _delegateSelectData) :
            base(module)
        {
            InitializeComponent();
            this.treatmentSample = _lisSample;
        ...
        private void SetDefaultValue()
        {
            try
            {
                //lblServiceReqCode.Text = treatmentSample.SERVICE_REQ_CODE;
                //lblBarcode.Text = treatmentSample.BARCODE;
                lblTreatmentCode.Text = treatmentSample.TREATMENT_CODE;
                lblPatientCode.Text = treatmentSample.TDL_PATIENT_CODE;
                lblPatientName.Text = treatmentSample.TDL_PATIENT_NAME;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sdo.SampleId = treatmentSample.ID;
