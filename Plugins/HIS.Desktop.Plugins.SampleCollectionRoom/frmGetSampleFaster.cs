    ...
    public partial class frmGetSampleFaster : HIS.Desktop.Utility.FormBase
    {
        ...
        internal void LoadBieuMauPhieuHen(string printTypeCode, string fileName, ref bool result)
        {
            try
            {
                ...
                MPS.ProcessorBase.Core.PrintData PrintData = new MPS.ProcessorBase.Core.PrintData(printTypeCode, fileName, mps000233RDO, MPS.ProcessorBase.PrintConfig.PreviewType.PrintNow, "");
                result = MPS.MpsPrinter.Run(PrintData);
