    ...
    public partial class frmChooseRoomForWaitingScreen : HIS.Desktop.Utility.FormBase
    {
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.CallPatientExpMest.Resources.Lang", typeof(HIS.Desktop.Plugins.CallPatientExpMest.frmChooseRoomForWaitingScreen).Assembly);
