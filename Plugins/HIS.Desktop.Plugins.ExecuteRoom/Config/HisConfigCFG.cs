...
namespace HIS.Desktop.Plugins.ExecuteRoom
{
    internal class HisConfigCFG
    {
        ...
        private const string CONFIG_KEY__REQUIED_DIPLOMA = "HIS.Desktop.Plugins.ExecuteRoom.RequiedDiploma";
        ...
        private const string CONFIG_KEY__SPECIALITY_WARNING_OPTION = "HIS.Desktop.Plugins.ExecuteRoom.SpecialityWarningOption";
        ...
        internal static string RequiedDiploma;
        ...
        internal static string SpecialityWarningOption;
        ...
        internal static void LoadConfig()
        {
            try
            {
                ...
                RequiedDiploma = GetValue(CONFIG_KEY__REQUIED_DIPLOMA);
                ...
                SpecialityWarningOption = GetValue(CONFIG_KEY__SPECIALITY_WARNING_OPTION);
