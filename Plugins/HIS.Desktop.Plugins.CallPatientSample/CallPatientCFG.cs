...
namespace HIS.Desktop.Plugins.CallPatientSample
{
    public class WaitingScreenCFG
    {
        ...
        private const string GRID_PATIENT_HEADER_BACK_COLOR_CODES = "SAMPLE.WAITING_SCREEN.BACK_COLOR_GRID_PATIENT_HEADER.COLOR_CODES";//Mã màu nền header của danh sách bệnh nhân
        private const string GRID_PATIENT_HEADER_FORCE_COLOR_CODES = "SAMPLE.WAITING_SCREEN.FORCE_COLOR_GRID_PATIENT_HEADER.COLOR_CODES";//Mã màu chữ header của danh sách bệnh nhân
        private const string GRID_PATIENT_BODY_FORCE_COLOR_CODES = "SAMPLE.WAITING_SCREEN.FORCE_COLOR_GRID_PATIENT_BODY.COLOR_CODES";//Mã màu chữ body của danh sách bệnh nhân
