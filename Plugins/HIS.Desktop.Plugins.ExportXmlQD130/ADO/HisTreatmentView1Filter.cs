...
namespace HIS.Desktop.Plugins.ExportXmlQD130.ADO
{
    public class HisTreatmentView1Filter : FilterBase
    {
        ...
        public string STORE_BORDEREAU_CODE__EXACT { get; set; }
        public string STORE_BORDEREAU_SEED_CODE__EXACT { get; set; }
