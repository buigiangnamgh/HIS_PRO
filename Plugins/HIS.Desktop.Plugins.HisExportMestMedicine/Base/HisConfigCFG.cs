...
namespace HIS.Desktop.Plugins.HisExportMestMedicine.Base
{
    class HisConfigCFG
    {
        ...
        private const string ip_siteWait = "HISMOS.HIS_SERVICE_REQ.IP_SITEWAIT";
        internal static string IP_SITEWAIT_CFG;
        ...
        internal static void LoadConfig()
        {
            try
            {
                IP_SITEWAIT_CFG = HisConfigs.Get<string>(ip_siteWait);
