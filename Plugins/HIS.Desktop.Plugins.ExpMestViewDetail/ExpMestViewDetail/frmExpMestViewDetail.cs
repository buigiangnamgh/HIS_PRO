    ...
    public partial class frmExpMestViewDetail : HIS.Desktop.Utility.FormBase
    {
        ...
        private void gridViewApprovalMedicine_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                ...
                if (_IS_NOT_PRES == 1)
                    e.Appearance.Font = new System.Drawing.Font(e.Appearance.Font, System.Drawing.FontStyle.Strikeout);
              long curentTime =  Inventec.Common.TypeConvert.Parse.ToInt64(Convert.ToDateTime(DateTime.Now).ToString("yyyyMMddHHmm") + "00");
                long _ExpiredDate = Inventec.Common.TypeConvert.Parse.ToInt64((vw.GetRowCellValue(e.RowHandle, "EXPIRED_DATE") ?? "").ToString());
                Inventec.Common.Logging.LogSystem.Debug("___ExpiredDate " + _ExpiredDate);
                if (_ExpiredDate < curentTime)
                {
