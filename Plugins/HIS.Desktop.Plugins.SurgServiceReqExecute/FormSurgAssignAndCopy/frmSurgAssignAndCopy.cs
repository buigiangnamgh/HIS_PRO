        ...
        private bool SetSurgAssignAndCopySDO(ref SurgAssignAndCopySDO sdo)
        {
            try
            {
                ...
                if (currentVHisService.ALLOW_SIMULTANEITY != 1)
                {
                    ...
                    LogSystem.Info(String.Format("kiem tra key ASSIGN_SERVICE_SIMULTANEITY_OPTION {0} ",Config.HisConfigKeys.ASSIGN_SERVICE_SIMULTANEITY_OPTION));
                    LogSystem.Info(String.Format("kiem tra key CHECK_SIMULTANEITY_OPTION {0} ",Config.HisConfigKeys.CHECK_SIMULTANEITY_OPTION));
                        ...
                        || Config.HisConfigKeys.ASSIGN_SERVICE_SIMULTANEITY_OPTION == "2")
                    {
                        ...
                        LogSystem.Info(String.Format("Login {0}",Login));
                        ...
                        LogSystem.Info(String.Format("inputSDO.TreatmentId {0}, {1}",inputSDO.TreatmentId,serviceReq.TREATMENT_ID));
                        ...
                        LogSystem.Info(String.Format("lstLogin {0}",lstLogin));
                        ...
                        LogSystem.Info(String.Format("inputSDO.Loginnames {0}",inputSDO.Loginnames));
                        string message = "";
                        ...
                        foreach (var item in mergedList)   
                        {
                            ...
                            string TimeDisplay =begin!=null? begin.Value.ToString("yyyyMMdd") : "00000000";
                            string strTimeDisplay =begin_BD!=null? begin_BD.Value.ToString("HHmmss") : "000000";
                            ...
                            string EndTimeDisplay =end!=null? end.Value.ToString("yyyyMMdd") : "00000000";
                            string EndstrTimeDisplay =end_BD!=null? end_BD.Value.ToString("HHmmss") : "000000";
                        ...
                        || Config.HisConfigKeys.CHECK_SIMULTANEITY_OPTION == "2")
                    {
                        ...
                        foreach (long item in mergedList)
                        {
                            ...
                            string TimeDisplay =begin!=null? begin.Value.ToString("yyyyMMdd") : "00000000";
                            string strTimeDisplay =begin_BD!=null? begin_BD.Value.ToString("HHmmss") : "000000"; // Định dạng HHmmss
                                                                                              // Nối hai chuỗi
                            ...
                            string EndTimeDisplay =end!=null? end.Value.ToString("yyyyMMdd") : "00000000"; // Định dạng YYYYMMDD
                            string EndstrTimeDisplay =end_BD!=null? end_BD.Value.ToString("HHmmss") : "000000"; // Định dạng HHmmss
        ...
        private List<DateTime> GetDateListFromTextBox(string text)
        {
            ...
            if (!string.IsNullOrEmpty(text))
            {
                ...
                foreach (string dateStr in dateStrings)
                {
                    ...
                    DateTime date;
                    if (DateTime.TryParseExact(dateStr.Trim(), "dd/MM", CultureInfo.InvariantCulture, DateTimeStyles.None, out date))
                    {
