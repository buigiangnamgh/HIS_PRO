...
namespace His.Bhyt.ExportXml.Base
{
    class HisConfigKey
    {
        ...
        internal const string XML__4210__XML4__ADD_DATA_OPTION = "XML.EXPORT.XML4.ADD_DATA_OPTION";
        internal const string XML__4210__NGAY_VAO_NOI_TRU_OPTION = "XML.EXPORT.4210.NGAY_VAO_NOI_TRU_OPTION";
        ...
        internal const string XML__4210__VNEID_OPTION = "XML.EXPORT.4210.VNEID_OPTION";
        /// <summary>
        ...
        internal const string Ct07OptionNgayChungTu = "MOS.HIS_TREATMENT.XML2076.CT07.NGAY_CHUNG_TU_OPTION";
        internal const string XML__MA_GIUONG_OPTION_CFG = "XML.EXPORT.MA_GIUONG_OPTION";
